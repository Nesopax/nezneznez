...
if(usePairingCode && !rxhl.authState.creds.registered) {
		const phoneNumber = await question('mohon masukin nomor lu buat terhubung ke bot fikzz awali dengan kode negara :\n');
...
console.log("ada yang nelpon lu tod")
})
rxhl.decodeJid = (jid) => {
if (!jid) return jid
if (/:\d+@/gi.test(jid)) {
